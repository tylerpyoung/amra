...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			// Add yamm classes
			if ( get_field('has_mega_menu', $item) ) {
				$classes[] = 'dropdown';
				$classes[] = 'yamm-fw';
			}

			// Add solo button style
			if ( get_field('is_solo_button_link', $item) ) {
				$classes[] = 'nav-solo-link';
				$classes[] = 'd-flex';
			...
			if ( (isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1) || (get_field('has_mega_menu', $item)) ) {
				$atts['href']          = $item->url;
				...
				if ( $depth > 0 ) {
					...
					$atts['class'] = 'nav-link';
					if ( get_field('is_solo_button_link', $item) ) {
						$atts['class'] = 'btn btn-outline-primary nav-dealerline d-none d-lg-inline-block';
					}
				}
			}
			...
			if ( get_field('has_mega_menu', $item) ) {
				...
				$output .= '<ul class="dropdown-menu">
											<li>
												<div class="yamm-content p-md-5">
													<div class="row">'
														. get_field('tab_content', $item, false) .
													'</div>
												</div>
											</li>
										</ul>
